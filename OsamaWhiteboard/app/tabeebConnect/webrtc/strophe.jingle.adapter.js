...
function getUserMediaWithConstraints(um, resolution, bandwidth, fps, screenSharingStreamId) {
    ...
    if (um.indexOf('desktop') >= 0) {
        constraints.video = {
            mandatory: {
                ...
                chromeMediaSourceId: screenSharingStreamId,
    ...
    try {
        console.info('RTC.getUserMedia constraints: ', constraints);
        RTC.getUserMedia(constraints,
                function (stream) {
                    console.log('onUserMediaSuccess');


                    console.log("window.peerconnection", window.peerconnection);
